...
priority_queue<Subject> to_do_subjects_generate(vector<Subject> subjects);
...
int main(){ 
    ...
    priority_queue<Subject> subjects_to_do = to_do_subjects_generate(subjects);
    ...
    show_schedule(subject_order, &subjects_to_do, 6);
...
priority_queue<Subject> to_do_subjects_generate(vector<Subject> subjects){
    priority_queue<Subject> subjects_to_do;
    for(auto subject : subjects){
        subjects_to_do.push(subject);
    }
    return subjects_to_do;
}